...
import { loginSuccess, sessionExpired } from '../../features/customer/store/customer.actions';
import { inject } from '@angular/core';
import { Store } from '@ngrx/store';
import { TokenService } from '../services/jwtToken.service';
import { adminLoginSuccess, adminSessionExpired } from '../../features/admin/store/admin.actions';
import { vendorLoginSuccess, vendorSessionExpired } from '../../features/vendors/store/vendor.actions';
...
export const AuthInterceptor: HttpInterceptorFn = (req: HttpRequest<any>, next: HttpHandlerFn): Observable<HttpEvent<any>> => {
    ...
    let tokenKey: string;
    const postRequests = new Set([ '/login', '/signup', '/admin/login', '/auth/google',
         '/vendor/login', '/vendor/signup', '/verify-otp', '/resend-otp',
          ]);
